              ...
              <div className="w-full max-w-md mx-auto px-2">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2 md:py-2.5 pl-10 rounded-full border-2 border-primary border-opacity-30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 text-sm md:text-base bg-white bg-opacity-20 text-primary placeholder-primary placeholder-opacity-80 backdrop-blur-sm"
                  />
                  <svg
